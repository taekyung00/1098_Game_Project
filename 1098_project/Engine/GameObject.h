...
namespace CS230 {
    ...
    public:
        ...
        GameObject(Math::ivec2 index);
        GameObject(Math::vec2 position, double rotation, Math::vec2 scale);
        GameObject(Math::ivec2 index, double rotation, Math::vec2 scale);
        virtual ~GameObject() {}

        virtual GameObjectTypes Type() = 0;
        virtual std::string TypeName() = 0;
        virtual int DrawPriority() const { return 10; }
        ...
        const Math::ivec2 GetIndex() const;
        Math::ivec2& SetIndex();
